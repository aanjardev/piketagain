...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Header("Temporary Win Screen Trigger")]
        public string WinSceneName = "WinScreen";

        [Header("Temporary Lose Screen Trigger")]
        ...
        private void OpenLoseScreen()
        {
            ...
            if (!IsSceneLoaded(LoseSceneName))
            {
